...
$(function(){
    ...
    (function(){
        ...
        function loadArticleData(){
            ...
            $(".article-person").text(aData.data.creatByFullName);
    ...
    //(function(){
    //    $(".main_left_bottom li span").click(function(){
    ...
    (function () {
        ...
        arrLi.css({"background": "url(images/list.gif)no-repeat", "color": "white"});
          ...
          $(".main_right").delegate("img", "click", function (){
            window.open("productShow.html?type=products&articleid="+(index+1)+"#"+oIndex);
        });
    })();
    (function () {
